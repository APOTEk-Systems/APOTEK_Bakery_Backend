...
// Global middleware
const allowedOrigins = ['https://pastry-pros-suite.vercel.app','http://localhost:4173', 'http://localhost:8000', 'http://localhost:8080', 'http://localhost:3000', 'https://bakery.apotek.co.tz', "https://www.bakery.apotek.co.tz"];
const corsOptions = {
